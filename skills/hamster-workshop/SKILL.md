...
If you haven't read `references/john_architecture.md` yet, do that first. It's a version-pinned summary of joharnessburg layout, the skills, hooks contract, templates mechanics — tighter than reading the live repo cold.
