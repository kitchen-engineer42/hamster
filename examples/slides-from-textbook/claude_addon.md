...
**Aesthetic discipline** (the lesson2slides lesson): teaching imagery is anti-aesthetic. Restraint, not decoration. Every visual element should teach a concept; if it can't be named "this teaches X," it doesn't belong on the slide. Color palette: 5 semantic colors max; no decorative animation unless the thing itself moves in reality.
