...
*Created by `/john:init` on {date}, using the **slides-from-textbook** template. Edit freely; this is your living plan.*
...
- {date}: PLAN.md scaffolded by `/john:init` using the slides-from-textbook template.
