...
*Created by John initialization on {date}, using the **slides-from-textbook** template. Edit freely; this is your living plan.*
...
- {date}: PLAN.md scaffolded by John using the slides-from-textbook template.
